...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(1145553, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Nether Water"
...
modrinth {
    ...
    projectId.set("real-nether-water")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Nether Water")
    dependencies {
